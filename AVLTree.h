...
class AVLTree {
 ...
 private:
  ...
  int numHelper (AVLNode *current) const;
  bool findHelper (const string x, AVLNode *const &current) const;
  string pathHelper (const string x, AVLNode *const &current) const;
  void insertHelper (string x, AVLNode *&current);
